...
watchPlayers()
{
	...
	winner sr\core\_rank::giveRankXP("win");
	...
	killcam.entity sr\core\_killcam::start(3, 10, killcam.eInflictor, killcam.attacker, killcam.sWeapon);
	wait 3;
...
playerEntityAction(entity)
{
	...
	self thread battleroyale\huds\_hint::draw(entity);
